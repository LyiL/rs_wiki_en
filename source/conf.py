...
html_context = {
    ...
    'github_repo': 'rs_wiki_en',  # GitHub 仓库名
    ...
    'source_suffix': '.md',  # 示例
    'wiki_cn_url': 'https://rs-wiki-cn.readthedocs.io/zh-cn/latest/',  # wiki中文地址
    'wiki_en_url': 'https://rs-wiki-en.readthedocs.io/en/latest/',  # wiki英文地址
}
